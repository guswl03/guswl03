...
- 성신여자대학교 융합보안공학과 재학
- 5G 및 SGX 관련 연구를 수행하는 학부연구생

## Interest

- 보안 요구사항 분석
- 클라우드 기반 5G 코어 네트워크 보안

## Research & Activities

- **ASK 2025 구두 발표**  
  5G 환경에서의 LBO 아키텍처 기반 로밍 서비스 도입을 위한 보안요구사항 분석
- **2025 한국융합보안학회 하계학술대회 발표**  
  5G LBO 로밍 아키텍처 도입을 위한 5G-AKA 인증 보안요구사항 분석
- **MobiSec 2025 포스터 발표**  
  *A Detection Framework for Identity Protection in Cloud-Based 5G Core Networks*
- **Skills2Work-Seoul** 사이버보안 교육 참여

## Focus

<code>5G Security</code> · <code>Cloud Security</code> · <code>Network Security</code> · <code>Intel SGX</code> · <code>C++</code> · <code>Linux</code>
...
- [**gilgilstaudy**](https://github.com/guswl03/gilgilstaudy) — BoB 길길 멘토 과제
